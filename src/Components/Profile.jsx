        ...
        <div className="bg-[#00BFA5] min-h-screen py-12 px-6">
            <div className="max-w-2xl mx-auto flex flex-col gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center gap-4">
                    ...
                    <p className="text-gray-400 text-sm">johndoe@email.com</p>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button className="w-full bg-[#FFD93D] text-gray-800 font-bold py-3 rounded-full shadow-lg hover:scale-105 transition-all duration-200 mt-2">
                            Save Changes ✅
                        </button>
                    </div>
                </div>
